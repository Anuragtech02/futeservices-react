...
if(isset($_POST["send"])){
	...
	$mail->Username = "futeenquiry@gmail.com"; //Username for SMTP authentication any valid email created in your domain
	$mail->Password = "fute12345"; //Password for SMTP authentication
	$mail->AddReplyTo("futeenquiry@gmail.com", "Reply name"); //reply-to address
	$mail->SetFrom("futeenquiry@gmail.com", "Asif18 SMTP Mailer"); //From address of the mail
	// put your while loop here like below,
	$mail->Subject = "Your SMTP Mail"; //Subject od your mail
	$mail->AddAddress("ramya.krish7@gmail.com", "Asif18"); //To address who will receive this email
