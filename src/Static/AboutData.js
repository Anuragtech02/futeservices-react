...
export const ExperienceData = {
  ...
  para: "Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim",
  // img: workImg,
  btnText: "Learn More",
};
...
export const AboutWork = [
  {
    icon: "https://pelicula.qodeinteractive.com/wp-content/uploads/2020/03/custom-icon-img-1.png",
    heading: "OUR DIRECTORS",
    para: "Lorem ipsum dolor sit amet, consec tur adipisicing elit, sed do.",
  },
  {
    icon: "https://pelicula.qodeinteractive.com/wp-content/uploads/2020/03/custom-icon-img-2.png",
    heading: "TV SHOWS",
    para: "Lorem ipsum dolor sit amet, consec tur adipisicing elit, sed do.",
  },
  {
    icon: "https://pelicula.qodeinteractive.com/wp-content/uploads/2020/03/custom-icon-img-3.png",
    heading: "FILM AWARDS",
    para: "Lorem ipsum dolor sit amet, consec tur adipisicing elit, sed do.",
  },
  {
    icon: "https://pelicula.qodeinteractive.com/wp-content/uploads/2020/03/custom-icon-img-4.png",
    heading: "FILM FESTIVALS",
    para: "Lorem ipsum dolor sit amet, consec tur adipisicing elit, sed do.",
  },
];
...
export const teamData = [
  {
    ...
    desc: "Soma leads with brilliant creative direction and works towards a seamless execution of all our projects. Her executive responsibilities include business strategy, new business development, portfolio management, employee management, and quality control. In addition to branding, film, CGI, and print collateral, she has extensive expertise in the design, and execution of complex sales gallery environments. Prior to joining Fute services ,she has spent more than a decade in sales leadership roles in a multinational company with an exceptional understanding of customer experience. In addition, she is responsible for client service and improving customer relations.",
  },
  {
    image: member2,
    ...
    desc: "Payel is a true powerhouse and one of the most versatile members of the team with a flair for creating boundless opportunities for the company. With an impressive experience of over 8+ years, she is the first to being new ideas to the table, with her proficiency in seamless business development strategies as well as her charisma and enthusiasm that ensure that the projects get the right exposure they deserve. She has been a strong pillar for Fute Services and is in charge of all the operations as well as the sales team. She has a post graduate degree as an Economist, with thorough skills acquired in Finance & HR. Her never-say-never attitude motivates and inspires the upcoming pioneers to take up their own endevours and never back down from a challenge.",
  },
  {
    image: member3,
