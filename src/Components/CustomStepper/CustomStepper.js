...
const lineWidth = (steps, activeStep) =>
  steps[(activeStep + 1) % steps.length] - steps[activeStep];
    ...
    <div className={style.container}>
      ...
      <div className={style.content}>
        ...
        <div className={style.text}>
          <h1
            style={{ color: theme === "dark" ? "#fff" : "#000" }}
          >{`"${content[activeStep].heading}"`}</h1>
          <p style={{ color: theme === "dark" ? "#fff" : "#000" }}>
            {content[activeStep].para}
          </p>
          <button
            style={{ opacity: 1 }}
            className={theme === "dark" ? style.btnLight : style.btnDark}
            href={content[activeStep].link}
          >
            Learn More
          </button>
        </div>
